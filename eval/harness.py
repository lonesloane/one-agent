...
SYSTEM_PROMPT = (
    ...
    " Before calling any tool that creates or modifies data,"
    " confirm that all required information has been provided by the"
    " user; if any required field is missing, ask for it before"
    " proceeding."
)
